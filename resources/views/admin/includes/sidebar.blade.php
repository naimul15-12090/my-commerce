        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="table-layout.html">Manage Order</a></li>
                ...
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="table-layout.html">Manage Customer</a></li>
                ...
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="table-layout.html">Add User</a></li>
                ...
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="table-layout.html">Add Coupon</a></li>
                        <li><a href="table-layout.html">Manage Coupon</a></li>
