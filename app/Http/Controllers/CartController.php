...
class CartController extends Controller
{
    ...
    public function index(Request $request, $id)
    {
        ...
        ShoppingCart::add($this->product->id, $this->product->name, $request->qty, $this->product->selling_price, ['image' => $this->product->image, 'category' => $this->product->category->name, 'subCategory' => $this->product->subCategory->name, 'brand' => $this->product->brand->name]);
